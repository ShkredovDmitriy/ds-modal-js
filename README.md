...
```
<link href="https://unpkg.com/ds-modal-js@0.2.21/dist/ds-modal.min.css" rel="stylesheet">
```
Add this line to the bottom of the body
```
<script src="https://unpkg.com/ds-modal-js@0.2.21/dist/ds-modal.min.js"></script>
```
